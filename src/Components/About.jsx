 ...
 */
import image from "../images/bgg1.jpg";
 ...
 */
const description =
  "I Completed my Bachelor's in Computer application and currently pursuing Master in Computer Application(to be completed by june 2025).i'm a Web Developer.";
